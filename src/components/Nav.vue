 ...
 * -----
 * Last Modified: Monday, 2nd July 2018 4:13:37 pm
...
<template>
    <div class="header">
        <div class="head">
            ...
            <div class="search">
                <input placeholder="Search" type="text" @keyup.enter="search">
                <div class="icon">
        ...
        <div class="nav">
            <ul>
                <li v-if="mikuConfig.modules.posts"><router-link to="/posts">POSTS</router-link></li>
                <li v-if="mikuConfig.modules.bangumi"><router-link to="/bangumi">BILIBILI</router-link></li>
